...
- User reported stage-specific outcomes: 美团 and 米哈游 were rejected after interview; 蔚来 and 联想 were rejected at resume screening. Exact interview rounds and actual outcome dates were not supplied, so new events use the 2026-09-18 report date. 联想's exact job title, JD and submission date remain unknown; do not invent an Applied event or `appliedDate`.
- User clarified that the existing 阿里千问 and OPPO rejections were resume-screening outcomes. Update the notes on their original Rejected events (2026-09-09 and 2026-09-03 respectively) without appending duplicate Rejected events.
